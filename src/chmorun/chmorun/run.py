...
def knight_logic(gc,directions,objects,my_team,unit, object_at_distance,location):
        ...
        try:
            for unit in gc.my_units():
                ...
                for objects in units_at_distance:
                    ...
                    if unit.unit_type == bc.UnitType.Knight:
                        print("Im a knight")
                        return_val = knight_logic(gc,directions,objects,my_team,unit,objects,location)
                        if (return_val == 1): continue
