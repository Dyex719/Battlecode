...
# if gc.can_sense_unit and other.team != my_team and gc.is_attack_ready(unit.id) and gc.can_attack(unit.id, other.id):
# def attack_nearest(unit_id,enemy_id):
#
#     gc.attack(unit_id, unit_id)
